...
export function ContactView({ onBack }: Props) {
  return <section className="contact-view" aria-labelledby="view-heading">
    ...
    <div className="contact-socials"><span>AROUND THE WEB</span><a href={links.github} target="_blank" rel="noreferrer">GitHub <ArrowUpRight /></a><a href={links.linkedin} target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight /></a></div>
